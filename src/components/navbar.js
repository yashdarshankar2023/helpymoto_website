...
const navbar = () => {
  return (
    <div className='navbar'>
      ...
      <Link to="/service" className='nav_items'>Service</Link>
      <Link to="/store" className='nav_items'>HM store</Link>
      
      <Link to="/about" className='nav_items'>About Us</Link>
      <Link to="/contact" className='nav_items'>Contact Us</Link>
      <div id="navbar_items">
